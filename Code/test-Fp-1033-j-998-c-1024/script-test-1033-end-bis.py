...
for end in range(7,13):
	...
	if calcul_isogenie_init(b,c,b2,c2,2,d,deg,e,f,g)[0]==True:
		...
		C=timeit('calcul_isogenie_init_bis(b,c,b,c,2,d,deg,e,f,g)',number=10,repeat=5,seconds=True,preparse=True)
		...
		C=timeit('calcul_isogenie_init(b,c,b,c,2,d,deg,e,f,g)',number=10,repeat=5,seconds=True,preparse=True)		
