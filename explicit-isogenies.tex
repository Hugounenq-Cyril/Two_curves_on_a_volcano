...
If we want to be able to distinguish two different horizontal paths on the crater of the volcano, we need the Frobenius to have two distincts eigenvalues which is only possible on the cyclic crater of a volcano of $2$-isogeny ($\ell$).
