...
Let~$ψ: E → E'$ be an isogeny of degree prime to~$ℓ$.
\begin{enumerate}
...
(ascending, descending, or horizontal with the same eigenvalue).
\end{enumerate}
\end{prop}

\begin{proof}
This is a consequence of Proposition~\ref{prop:matrice-frobenius}
