...
As we consider a rational $r$ isogeny we have to compute an interpolation polynomial $L$ with the same properties as the rational isogeny: 
\begin{itemize}
