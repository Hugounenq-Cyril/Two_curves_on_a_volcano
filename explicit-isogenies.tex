...
The computational cost of the interpolation step is of $O(rM(r)\log(r))$ since the cost of the precomputations are of $O(M(r)\log(r)^2)$ and we got to repeat this step $O(r)$ times until we find the good interpolation.
