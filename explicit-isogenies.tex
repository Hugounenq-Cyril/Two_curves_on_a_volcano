...
\todo{complete the complexity}
 First we compute $k$ such that $3\ell^{2k-2}>'r$. We compute a basis of the $\ell$ torsion solving a division polynomial of degree $\ell^2$, thus we have a complexity of $O(..)$.%Cantor Zassenhauss dans F_1
