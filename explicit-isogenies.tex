...
so that the valuation of~$a$ is well-defined.
...
$h$, it has an expected running time quasi-quadratic in the isogeny
...
asymptotic density of Elkies primes is $1/2$, and the height $h$ is
...
$h∈O(\log(q))$, and that under the Generalize Riemann Hypothesis $ℓ$
