...
\todo{Proposion pour Ionica-Joux: We could also have studied the action of the pairing, like it is done in \cite{IonicaJ10} since it gives results to get directions in the volcano, but we won't do it here.}
