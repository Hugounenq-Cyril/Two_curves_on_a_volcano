...
\todo{complete the complexity}
 To compute an horizontal basis, first we have to compute a diagonalized basis. We compute a basis of the $\ell$ torsion solving a division polynomial of degree $\ell^2$, thus we have a complexity of $O$%Cantor Zassenhauss dans F_1
 Then we can use \ref{alg:diagonal} to compute a diagonal basis with a complexity of 
\newline  
