...
At the end of step $1$ we got a polynomial $T$ of degree $2\frac{\ell^{k-2+s}}{2}$. The degree of the polynomial $T$ at the step $5$ of the algorithm and at the $r$-th iteration is $2^r\ell^{k-2+s}+\frac{\ell^{k-1+s}}{2}\sum_{i=1}^r2^i$.
\newline
After $j-1$ iterations of step $2-6$ of algorithm \ref{alg:computingLT} the degree of $T$ is $\ell^{k-2+s}(2^{j-1}+\ell(2^{j}-1))$. After $j$ iterations of step $2-6$ of algorithm \ref{alg:computingLT} the degree of $T$ is $\ell^{k-2+s}(2^{j-1}+\ell(2^{j}-1))$
\newline
