...
Since $π(x P + y Q) = λ x P \,+\, μ y Q$,
we see that the Galois orbits of~$E[ℓ^k]$ correspond bijectively to
points in the fundamental domain of the \emph{multiplicative} lattice
in~$(ℚ_ℓ^×)^2$ generated by the columns of
the matrix~$\smat{1 + O(ℓ^k) & 1 & λ \\ 1 & 1+O(ℓ^k) & μ}$.
