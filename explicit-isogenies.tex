...
Since we need for this algorithm a basis of the $\ell$ torsion, we 
state the complexity of solving a division polynomial of degree $\ell^2$. 
It has a complexity of $O(M(l)\log(\ell) \ell^5 \log(\ell^2) \log(q))$, 
using Cantor-Zassenhauss in $F_1$. 
