...
modulo~$ℓ^{k}$, where~$k>h = v_{ℓ} (λ_1-λ_2)$ as in the previous section.

The complexities of all algorithms are given as a number of
...
For a point $P \in E$ we will denote by $P \leftarrow P/\ell$ 
the computation of a preimage of multiplication by $\ell$ of 
a point, when such a preimage exists.
