...
\end{itemize}}
\pause
We can't use anymore the fact that $\phi$ send $E[\ell^k]$ on $E'[\ell^k]$, those groups are too big, we have to do more restrictions:
\begin{itemize}
...
%\item $\color{blue} \only<2-2>{Q_2}\only<3-3>{Q_3}$preimage by the $\ell$ multiplication of \only<2-2>{$P_1$}\only<3-3>{$P_2$} such that $\pi(\color{blue} \only<2-2>{Q_2}\only<3-3>{Q_3} \color{black})= \color{blue} \lambda \only<2-2>{Q_2}\only<3-3>{Q_3}$ with $\color{blue} \only<2-2>{Q_2}\only<3-3>{Q_3}$ a point of order $\only<2-2>{\ell^2}\only<3-3>{\ell^3}$.
\end{itemize}}
...
\[
\color{red} T_{\lambda}(E) \color{black} \oplus \color{blue} T_{\mu}(E) \color{black} \bmod  \only<1-1>{ \textit{\boldmath  $\ell^1$ \unboldmath }}\only<2-2>{ \textit{\boldmath  $\ell^2$ \unboldmath }}\only<3-3>{ \textit{\boldmath  $\ell^3$ \unboldmath }} 
\]
