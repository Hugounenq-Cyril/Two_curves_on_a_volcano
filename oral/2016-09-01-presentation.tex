...
$\ker(\pi- \blu \mu)$ is a cyclic group of size $\ell^3$.
\end{column}
\begin{column}{5cm}
...
We proceed step by step by walking along the volcano crater according to the directions $\red \lambda, \blu \mu$.
\begin{center}
