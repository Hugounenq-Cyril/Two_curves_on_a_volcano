...
\end{itemize}}
Therefore we study the $\ell$-torsion group and the action of the Frobenius endomorphism on it.
\end{frame}
...
Since the Frobenius endomorphism $\pi$ diagonalizes as
...
We compute points:
\begin{itemize}
\item $\color{red} \only<1-1>{P_1}\only<2-2>{P_2}\only<3-3>{P_3}$ such that $\pi(\color{red} \only<1-1>{P_1}\only<2-2>{P_2}\only<3-3>{P_3} \color{black})= \color{red} \lambda \only<1-1>{P_1}\only<2-2>{P_2}\only<3-3>{P_3} $ with $\color{red} \only<1-1>{P_1}\only<2-2>{P_2}\only<3-3>{P_3}$ a point of order $\only<1-1>{\ell}\only<2-2>{\ell^2}\only<3-3>{\ell^3}$,
\item  $\color{blue} \only<1-1>{Q_1}\only<2-2>{Q_2}\only<3-3>{Q_3}$ such that $\pi(\color{blue} \only<1-1>{Q_1}\only<2-2>{Q_2}\only<3-3>{Q_3} \color{black})= \color{blue} \mu \only<1-1>{Q_1}\only<2-2>{Q_2}\only<3-3>{Q_3}$ with $\color{blue} \only<1-1>{Q_1}\only<2-2>{Q_2}\only<3-3>{Q_3}$ a point of order $\only<1-1>{\ell}\only<2-2>{\ell^2}\only<3-3>{\ell^3} $.
\end{itemize}
then through those points we have determined a part of $T_{\ell}(E)$:
\[
\color{red} T_{\lambda}(E) \color{black} \oplus \color{blue} T_{\mu}(E) \color{black} \bmod \only<1-1>{ \textit{\boldmath  $\ell$ \unboldmath }} 
\only<2-2>{ \textit{\boldmath  $\ell^2$ \unboldmath }}
\only<3-3>{ \textit{\boldmath  $\ell$ \unboldmath }}  
\]
