...
\begin{frame}
\begin{tabular}{p{10em}p{3em}p{10em}}
...
\pause
We assume that $\pi$ splits $\bmod \ell$:
it means that its minimal polynomial factors as:
...
Thus we want to compute two $\ell^k$ isogenies of direction $\lambda, \mu $. 
