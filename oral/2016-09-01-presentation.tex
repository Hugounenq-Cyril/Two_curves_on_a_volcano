...
\begin{enumerate}
\item Select the least $k$ such that $p^k \approx r$;
...
$\ell^k$-subgroups of direction $\lambda, \mu $. 
...
$\color{red}{E[\ell^k]_{{\lambda}}} \color{black}{\rightarrow} \color{red}{E'[\ell^k]_{{\lambda}}}$ and 
...
\]
we cannot immediately distinguish kernels of isogenies of direction $\red
