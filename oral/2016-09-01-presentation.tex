...
\begin{column}[l]{5cm}
\orangebox{}{
On $E_1$ we have determined this part of $T_{\ell}(E_1)$:
\[
\[ \color{red}T_{\lambda} \color{black} \bmod \ell^2
\]}
\end{column}
\begin{column}[r]{7cm}
\begin{figure}
...
\begin{column}[l]{5cm}
\orangebox{}{
On $E_3$ we have determined this part of $T_{\ell}(E_3)$:
\[
\[ \color{red}T_{\lambda} \color{black} \bmod \ell^3
\]}
\end{column}
\begin{column}[r]{7cm}
\begin{figure}
...
\begin{scope}[yshift=10cm]
	\begin{scope}[xshift=4.3cm]
		...
		\node (E) at (-1.5,-0.5) {$\color{red} \lambda$};
		\node (F) at (1.5,-0.5) {$\color{red} \lambda$};
		\node (G) at (0,1.5) {$\color{red} \lambda$};
			\begin{scope}[xshift=-3cm]
			\coordinate (A) at (0,0);
			\coordinate (C) at (270:4.2);
			\coordinate (CA) at (265:7.5);
