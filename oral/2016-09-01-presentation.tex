...
\[
\color{red} T_{\lambda}(E) \color{black} \oplus \color{blue} T_{\mu}(E) \color{black} \bmod \textit{\boldmath  $\ell$ \unboldmath } 
\]
}
\only<2-2>{
\[
...
then we have determined a part of $T_{\ell}(E)$:
\[
\color{red} T_{\lambda}(E) \color{black} \oplus \color{blue} T_{\mu}(E) \color{black} \bmod \textit{\boldmath  $\ell^2$ \unboldmath } 
\]
}
...
then we have determined a part of $T_{\ell}(E)$:
\[
\color{red} T_{\lambda}(E) \color{black} \oplus \color{blue} T_{\mu}(E) \color{black} \bmod \textit{\boldmath  $\ell^3$ \unboldmath } 
\]
}
\end{exe}
