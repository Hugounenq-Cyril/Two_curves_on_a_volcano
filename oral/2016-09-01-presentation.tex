...
\begin{itemize}
 ...
 \item rational maps (of finite degree).
\end{itemize}
...
\begin{frame}
\bluebox{Fact}{
Let $\phi$ be an $r$-isogeny, with $\ell \nmid r$, then  $\phi$ preserves the directions $\lambda, \mu $ of $\ell$-isogenies.}
